...
<body>
    ...
    <script src="<?= asset_url() ?>js/plugins/morris/morris-data.js"></script>

    <!-- Flot Charts JavaScript -->
    <!--[if lte IE 8]><script src="<?= asset_url() ?>js/excanvas.min.js"></script><![endif]-->
    ...
    <script src="<?= asset_url() ?>js/plugins/flot/flot-data.js"></script>
